...
-->
    ...
    <div id="top">
      ...
      <table align ="center" bgcolor="yellow">
        <tr>
          <th style="padding:30px;">Food Name
          </th>
          <th style="padding:30px;">Price
          </th>
          <th style="padding:30px;">Quantity
          </th>
          <th style="padding:30px;">Action
          </th>                    
        </tr> 
        ...
        @csrf
          ...
          @foreach($data2 as $data2)
            ...
            <td style ="position: relative;top:-50px; right: -360px">
              <a href="{{url('/removecart',$data2->id)}}" class="btn btn-warning"> Remove 
              </a>
            </td>
        ...
        <div id="appear" align="center" style="padding: 10px;display:none;">
          ...
          <div style="padding: 10px">
            ...
            <input type="num" name="phone" placeholder="Phone Number">
          </div> 
          <div style="padding: 10px">
            <label>Address
            </label>
          ...
          <div style="padding: 10px">
            ...
            <button id="close"  type="button" class="btn btn-danger">Close
            </button>
          </div> 
        </div>
        </div>
